      ...
      <div class="pb-50">
        <div class="container bg-shadow bg-width">
          <div class="row">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                           ...
                           <div class="form-group">
								...
								$_SESSION['product_id'] = $_REQUEST['package']." Notice";
								?>
							...
							<input type="hidden" name="item_name" value="<?php echo $_REQUEST['package']." Notice";?>">
						   ...
						   <input type="hidden" name="cancel_return" value="http://webtechnomind.com/work/petroleague/noticecancel.php">
							<input type="hidden" name="return" value="http://webtechnomind.com/work/petroleague/noticesuccess.php">
			...
			<form class="form-horizontal from2" method="post" action="instamojo-php-master/instamojo-payment3.php">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
							...
							<div class="form-group">
                                <div class="col-md-6 col-xs-12">
                                    <strong>Username:</strong>
                                    <input type="text" name="name" class="form-control" value="<?php echo $fetch_student['username']; ?>" readonly/>
                                </div>
                            </div>
							<div class="form-group">
                                <div class="col-md-12"><strong>Phone No.:</strong></div>
							...
							<div class="form-group">
								...
								?>
							<input type="hidden" name="product_name" value="<?php echo $_REQUEST['package']." Notice";?>">
							<input type="hidden" name="product_price" value="<?php echo $_REQUEST['price'];?>">
							<div class="form-group">
								<div class="col-md-12">
								<input type="submit" class="btn btn-primary" value="Payment" name="payment"/>
								</div>
