      ...
      <div class="pb-50">
        <div class="container bg-shadow bg-width">
          <div class="row">
			...
			$date  = date('Y-m-d');
			$payment_insert = mysql_query("insert into `admin_payment_subscription` (`user_id`,`product_name`,`payment_mode`,`payment_gross`,`txn_id`,`mc_currency`,`satus`,`date`) values ('".$userid."','Subscription','Paypal','".$price."','0','USD','Cancel','".$date."')");
