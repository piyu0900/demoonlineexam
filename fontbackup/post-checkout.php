      ...
      <div class="pb-50">
        <div class="container bg-shadow bg-width">
          <div class="row">
			...
			<?php
			$get_company = mysql_query("select * from `admin_company` where  `admin_company`.`id` = '".$_SESSION["userid"]."'");
			$fetch_company = mysql_fetch_array($get_company);
			?>
			<?php
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-xs-12">
                                    ...
                                    <input type="text" name="fullname" class="form-control" value="<?php echo $fetch_company['company_name']; ?>" readonly/>
                                </div>
                                <div class="span1"></div>
                                <div class="col-md-6 col-xs-12">
                                    <strong>Username:</strong>
                                    <input type="text" name="username" class="form-control" value="<?php echo $fetch_company['username']; ?>" readonly/>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12"><strong>Address:</strong></div>
                                <div class="col-md-12">
                                    <input type="text" name="address" class="form-control" value="<?php echo $fetch_company['company_address']; ?>" readonly/>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12"><strong>Email:</strong></div>
                                <div class="col-md-12">
                                    <input type="email" name="email" class="form-control" value="<?php echo $fetch_company['company_email']; ?>" readonly/>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12"><strong>Phone No.:</strong></div>
                                <div class="col-md-12">
                                    <input type="text" name="phone" class="form-control" value="<?php echo $fetch_company['company_phone_no']; ?>" readonly/>
                                </div>
                            </div>
                           <div class="form-group">
								...
								$_SESSION['price'] = "1000";
								$_SESSION['product_id'] = "Post Unlimited";
								?>
                                    <input type="text" name="price" class="form-control" value="1000" readonly/>
                                </div>
                            </div>
							
							<input type="hidden" name="business" value="<?php echo $paypal_id; ?>">
							<input type="hidden" name="cmd" value="_xclick">
							<input type="hidden" name="item_name" value="Post Unlimited">
						   ...
						   <input type="hidden" name="cancel_return" value="http://webtechnomind.com/work/petroleague/postcancel.php">
							<input type="hidden" name="return" value="http://webtechnomind.com/work/petroleague/postsuccess.php">
