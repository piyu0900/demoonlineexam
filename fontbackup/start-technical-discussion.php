...
<div id="topicModal" class="modal fade login-box-wrapper" tabindex="-1" data-width="550" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
				...
				<div class="modal-footer text-center">
					...
					<!--<button type="button" class="btn btn-primary" id="but_code1">Submit</button>-->
...
<?php
$get_topics = mysql_query("select * from `admin_technical_discussion`");

while($fetch_topic = mysql_fetch_array($get_topics))
{
	?>
		  
	<div>    
		<div class="col-md-12"><h4><a class="col" href="comments.php?topic=<?php echo $fetch_topic['id']; ?>"><?php echo $fetch_topic['title']; ?></a></h4></div>          
			  
		<hr>

		<div class="col-md-12">
		 <p class="text-color"> <?php 
		 //echo $fetch_topic['discussion']; 
		 $discussion = $fetch_topic['discussion']; 
		 echo $result = substr($discussion, 0, 300);
		 ?>...<a href="comments.php?topic=<?php echo $fetch_topic['id']; ?>">More</a></p> 
		</div>             
