      ...
      <div class="pb-50">
        <div class="container bg-shadow bg-width">
          <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
						   ...
						   <input type="hidden" name="cancel_return" value="http://webtechnomind.com/work/petroleague/subscriptioncancel.php">
							<input type="hidden" name="return" value="http://webtechnomind.com/work/petroleague/subscriptionsuccess.php">
			...
			<form class="form-horizontal from2" method="post" action="instamojo-php-master/instamojo-payment2.php">
