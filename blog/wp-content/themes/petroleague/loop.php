...
<?php /* How to display all other posts. */ ?>
	...
	<?php else : ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		 ...
		 <div class="col-page col-md-4">
              <a href="<?php the_permalink(); ?>" class="fondo-publicacion-home">
                <div class="img-publicacion-home">
                     <img class="img-responsive" src="<?php echo $image[0];?>" width="100%" alt="image">
                </div>


                <div class="contenido-publicacion-home">
 <span class="user-date"><i class="fa fa-clock-o" aria-hidden="true"></i><?php echo get_the_date();?> <i class="fa fa-user-circle" aria-hidden="true"></i> <?php echo get_the_author();?></span>
                  <h3><?php the_title(); ?></h3>
                  <p> <?php echo substr(get_the_content(),0,120)?><span>...</span></p>
                </div>
