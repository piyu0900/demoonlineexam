...
function twentyten_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'left addversite', 'twentyten' ),
	...
	register_sidebar( array(
		'name' => __( 'Right addversite', 'twentyten' ),
	...
	register_sidebar( array(
		'name' => __( 'Middle addversite', 'twentyten' ),
	...
	register_sidebar( array(
		'name' => __( 'Middle center add', 'twentyten' ),
	...
	register_sidebar( array(
		'name' => __( 'Slider right add', 'twentyten' ),
