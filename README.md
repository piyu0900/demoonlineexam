This is online exam(multiple choose) website. I have made in core php and mysql. Student have to login first then start exam. It is multiple choose exam with negitive
