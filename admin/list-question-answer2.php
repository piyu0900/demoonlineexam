...
if(isset($id) && $id!=""){
$db->deleteData(DTABLE_ADMIN_QUESANSW2,"id=".$id);
...
<?php 
$sql = "SELECT * FROM ".DTABLE_ADMIN_QUESANSW2." ORDER BY id DESC";
...
while($row_rec = $db->getRow($res)){
	...
	<td>
	<a href="edit-question-answer2.php?id=<?php echo $row_rec['id']; ?>" title="Edit"><img src="images/pencil.png" width="16" height="16" alt=""></a>
	<a href="list-question-answer2.php?id=<?php echo $row_rec['id']; ?>" title="Delete"  onClick="return confirm('Are you sure you to delete this data?');"><img src="images/cross.png" width="16" height="16" alt=""></a> 
	</td>
	</tr>
	<?php
}
